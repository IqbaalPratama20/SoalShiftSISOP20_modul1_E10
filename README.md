...
Pada code soal3.sh tersebut merupakan kode gabungan dari no 3a dan 3c dimana untuk mendownload menggunakan wget dan -O untuk meletakkan output file pada directory yang kita inginkan, kemudian 2&>1 untuk mengexclude error dan tee untuk mendapatkan serta menuliskan messages log ke directory yang kita inginkan

Dilakukan perulangan 28 kali sesuai di soal yang meminta mendownload gambar sebanyak 28 kali, setelah itu akan dihitung jumlah file di folder kenangan sekarang di variabel counterken dan jumlah file di folder duplicate sekarang dengan variabel counterdup. Setelah itu jika ternyata tidak ada file di folder kenangan maka file yang didownload langsung dipindahkan ke folder kenangan dengan indeks 1, namun jika ada maka akan dibandingkan lagi antara file yang sudah didownload dengan semua file yang ada di folder kenangan dengan fungsi diff, jika ternyata ada yang sama maka akan dipindah di folder duplicate, jika ternyata tidak ada file di folder duplicate maka dipindah dan diberi indeks 1, namun jika ada diberi indeks counterdup + 1, jika ternyata folder yang di download sebelumnya tidak ada di folder kenangan maka dibuat file di folder kenangan baru dengan indeks counterken + 1, setelah perulangan selesai maka baru dicopy file wget.log ke wget.log.bak sebagai backup
